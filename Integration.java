...
public class Integrate {
	...
	public static void main(String[] args) {
		// This part of the code will say hello using a variety of questions to
		// ensure the user is human

		System.out.println();
		Scanner scanner = new Scanner(System.in);
		System.out.println(
				"Occupy Mars! To ensure you are not a robot, we'll need the following info");
		System.out.println();
		...
		System.out.println();
		System.out
				.println("Now we'll manipulate some of string data you entered...");
		System.out.println("Your name in uppercase is: " + myName.toUpperCase());
		System.out.println(
				"The second letter in your name is: " + myName.substring(1, 2));
		System.out.println("This is your name without vowels: "
				+ myName.replaceAll("[AEIOUaeiou]", ""));
		...
		System.out.println("The result of the subtraction of your two numbers is: "
				+ subtractNumbers(first_num, second_num));
		System.out
				.println("Let's cast that as a double so that your result becomes: "
						+ (double) (subtractNumbers(first_num, second_num)));
